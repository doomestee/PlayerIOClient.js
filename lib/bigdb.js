...
class BigDB {
    ...
    */
    createObject(table, key, obj) {
        ...
        return this.channel.createObjects([{ key: key, table: table, properties: properties}], false)
            .then(results => {
                if (results.errorcode) return new PlayerIOError(results.errorcode, results.message);
    ...
    loadMyPlayerObject() {
        return this.channel.loadMyPlayerObject()
            .then(result => {
                ...
                return new DatabaseObject(this, "PlayerObjects", result.playerobject.key, result.playerobject.version, true, result.playerobject.properties);
            });
    }
    ...
    * @param {number} limit The max amount of objects to return.
    */
