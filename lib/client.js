...
const GameFS = require("./gamefs.js");
const PayVault = require("./payvault.js");
...
module.exports = class PlayerIOClient {
	 ...
	 * @param {object} authenticationArguments A dictionary/object of arguments for the given connection. (CUSTOM; if they're spotted, they'll be extracted from and removed from the object, as they're used only for this lib: "proxy" - string)
	...
	static authenticate(gameId, connectionId, authenticationArguments, playerInsightSegments) {
		...
		if (authenticationArguments.proxy !== undefined) {
			channel.proxyAgent = new ProxyAgent(authenticationArguments.proxy);
			delete authenticationArguments.proxy;
		}
