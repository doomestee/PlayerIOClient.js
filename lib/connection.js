...
module.exports = class Connection {
     ...
     * @param {import("https-proxy-agent").HttpsProxyAgentOptions<string> & { uri: string }} proxyUse
    */
    constructor(developmentServer, endpoints, joinKey, joinData, proxyUse=null) {
        /**
        ...
        if (proxyUse !== null) {
            this.proxyObj = proxyUse;
        } else this.proxyObj = null;
    }
    ...
    connect() {
        return new Promise((res, rej) => {
            ...
            let tryNextEndpoint = () => {
                ...
                if (this.proxyObj) {
                    let agent = new HttpsProxyAgent(this.proxyObj.uri, this.proxyObj);

                    socketObj.agent = agent;
                }

                // attempt to create a socket connection
                this.socket = new WebSocket(((this.developmentServer) ? "ws://" : "wss://") + endpoint + "/", socketObj);
