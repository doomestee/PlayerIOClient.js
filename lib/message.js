const { entryType_Integer, entryType_UnsignedInteger, entryType_Long, entryType_UnsignedLong, entryType_Boolean, entryType_Float, entryType_Double, entryType_ByteArray, entryType_String } = require("./utilities");
    ...
    * @return {string} */
    ...
    get(index, type) {
        if (index > this.length) {
            throw Error("this message (" + self.type + ") only has " + this.objects.length + " entries");
        } else {
