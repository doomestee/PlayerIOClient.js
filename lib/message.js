const { entryType_Integer, entryType_UnsignedInteger, entryType_Long, entryType_UnsignedLong, entryType_Boolean, entryType_Float, entryType_Double, entryType_ByteArray, entryType_String } = require("./utilities.js");
...
module.exports = class Message {
     ...
     */
    addInt(value) {
        this.addT(value >= -2147483648 && value <= 2147483647, Math.trunc(value), entryType_Integer, "an integer (32bit)");
    }
    ...
    */
    addUInt(value) {
        this.addT(value >= 0 && value <= 4294967295, Math.trunc(value), entryType_UnsignedInteger, "an unsigned integer (32bit)");
    }
    ...
    */
    addLong(value) {
        //Boundary is rounded because max_long and min_long can't be accurately represented as double
        this.addT(value >= -9223372036854775000 && value <= 9223372036854775000, Math.trunc(value), entryType_Long, "a long (64bit)");
    }
    ...
    */
    addULong(value) {
        //Boundary is rounded because max_ulong can't be accurately represented as double
        this.addT(value >= 0 && value <= 18446744073709550000, value, entryType_UnsignedLong, "an unsigned long (64bit)");
    }
    ...
    */
    addBoolean(value) {
        this.addT(true, value ? true : false, entryType_Boolean, "a boolean value");
    }
    ...
    */
    addFloat(value) {
        this.addT(true, Number(value), entryType_Float, "a floating point value (32bit)");
    }
    ...
    */
    addDouble(value) {
        this.addT(true, Number(value), entryType_Double, "a double floating point value (64bit)");
    }
    ...
    */
    addByteArray(value) {
        this.addT(this.isByteArray(value), value, entryType_ByteArray, "a bytearray");
    }
    ...
    */
    addString(value) {
        this.addT(true, value + '', entryType_String, "a string");
    }
    ...
    * @return {number} */
    getInt(index) {
        return this.get(index, entryType_Integer)
    }
    ...
    * @return {number} */
    getUInt(index) {
        return this.get(index, entryType_UnsignedInteger)
    }
    ...
    * @return {number} */
    getLong(index) {
        return this.get(index, entryType_Long)
    }
    ...
    * @return {number} */
    getULong(index) {
        return this.get(index, entryType_UnsignedLong)
    }
    ...
    * @return {boolean} */
    getBoolean(index) {
        return this.get(index, entryType_Boolean)
    }
    ...
    * @return {number} */
    getDouble(index) {
        return this.get(index, entryType_Double)
    }
    ...
    * @return {number} */
    getFloat(index) {
        return this.get(index, entryType_Float)
    }
    ...
    * @return {number} */
    getByteArray(index) {
        return this.get(index, entryType_ByteArray)
    }
    ...
    * @return {string} */
    getString(index) {
        return this.get(index, entryType_String)
    }
    ...
    * @return {string} */
    ...
    getTypeString(type=0) {
        let t = {
            [entryType_Integer]: "Integer",
            [entryType_UnsignedInteger]: "Unsigned Integer",
            [entryType_Long]: "Long",
            [entryType_UnsignedLong]: "Unsigned Long",
            [entryType_Double]: "Double",
            [entryType_Float]: "Float",
            [entryType_String]: "String",
            [entryType_ByteArray]: "ByteArray",
            [entryType_Boolean]: "Boolean"
        }
    ...
    /**
     * Will create a clone of the passed message, returning a new class that's just exactly like it is.
     */
    static clone() {
        let msg = new this(this.type);
    }
}