...
let entryType_Integer = 0;
let entryType_UnsignedInteger = 1;
let entryType_Long = 2;
let entryType_UnsignedLong = 3;
let entryType_Double = 4;
let entryType_Float = 5;
let entryType_String = 6;
let entryType_ByteArray = 7;
let entryType_Boolean = 8;
